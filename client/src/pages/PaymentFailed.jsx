...
function PaymentFailed() {
  ...
  return (
    ...
    >
      {/* Glow */}
      <div className="absolute w-80 h-80 bg-red-600/8 rounded-full blur-3xl pointer-events-none" />
      ...
      <motion.div
        ...
        className="relative w-24 h-24 rounded-full
          ...
          flex items-center justify-center text-red-400 text-5xl"
      >
        <FaTimesCircle />
      </motion.div>
      ...
      >
        ...
        <p className="text-red-400 font-medium mb-1">Something went wrong with your payment.</p>
