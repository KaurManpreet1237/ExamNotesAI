...
// ─── Public landing page ───────────────────────────────────────────────────────
// Google auth lives exclusively on /login and /signup now.
// This page is purely a marketing entry point — no auth logic here.
function Auth() {
    ...
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
      ...
      <main className='max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center'>
        ...
        >
          ...
          {/* CTA — navigates to login; Google button stays on login page */}
          <motion.button
